...
public class RoomController {
    ...
    @PostMapping("page")
    public Response<Page<Room>> page(@RequestParam(required = false, defaultValue = "1") Integer pageNumber, @RequestParam(required = false, defaultValue = "10") Integer pageSize) {
