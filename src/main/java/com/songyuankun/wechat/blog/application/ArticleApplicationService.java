...
public class ArticleApplicationService {
    ...
    public ArticleApplicationService(ArticleRepository articleRepository, CategoryServiceImpl categoryService, TagServiceImpl tagService, WeChatUtil weChatUtil) {
